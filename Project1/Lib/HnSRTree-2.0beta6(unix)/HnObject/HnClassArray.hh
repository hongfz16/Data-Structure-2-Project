 ...
 * $Id: HnClassArray.hh,v 1.7 2010/03/09 06:58:09 katayama Exp $
 */
...
public:
    /* constructors */
    friend _HNSRTIMP HnClassArray new_HnClassArray(int length);
    friend _HNSRTIMP HnClassArray new_HnClassArray(const HnClassArray &ptr);
...
_HNSRTIMP HnClassArray new_HnClassArray(int length);
_HNSRTIMP HnClassArray new_HnClassArray(const HnClassArray &ptr);
...
public:
    /* constructors */
    friend _HNSRTIMP HnClassVector new_HnClassVector(void);
    friend _HNSRTIMP HnClassVector new_HnClassVector(const HnClassVector &ptr);
...
_HNSRTIMP HnClassVector new_HnClassVector(void);
_HNSRTIMP HnClassVector new_HnClassVector(const HnClassVector &ptr);
...
protected:
    const char *getClassName(void) const { return HnClassNameString; }
