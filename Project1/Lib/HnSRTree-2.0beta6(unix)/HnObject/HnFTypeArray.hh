 ...
 * $Id: HnFTypeArray.hh,v 1.6 2010/03/08 18:26:27 katayama Exp $
 */
...
public:
    /* constructors */
    friend _HNSRTIMP HnFTypeArray new_HnFTypeArray(int length);
    friend _HNSRTIMP HnFTypeArray new_HnFTypeArray(const HnFTypeArray &ptr);
...
_HNSRTIMP HnFTypeArray new_HnFTypeArray(int length);
_HNSRTIMP HnFTypeArray new_HnFTypeArray(const HnFTypeArray &ptr);
...
public:
    /* constructors */
    friend _HNSRTIMP HnFTypeVector new_HnFTypeVector(void);
    friend _HNSRTIMP HnFTypeVector new_HnFTypeVector(const HnFTypeVector &ptr);
...
_HNSRTIMP HnFTypeVector new_HnFTypeVector(void);
_HNSRTIMP HnFTypeVector new_HnFTypeVector(const HnFTypeVector &ptr);
